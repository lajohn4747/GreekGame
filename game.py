...
def main():
	...
	scene2 = Scene(DISPLAYSURF, people2, first, background = pygame.image.load('athens_for_now.png').convert(), transition_points = {2:[0,100,325,399], 3:[325,399,500,600], 4:[500,600,250,324]})
	...
	scene10= Scene(DISPLAYSURF, people2, first, background = pygame.image.load('sparta_for_now.png').convert(), transition_points = {2:[0,100,325,399], 3:[325,399,500,600], 4:[500,600,250,324]})
	scene11= Scene(DISPLAYSURF, people2, first, background = pygame.image.load('delphi_for_now.png').convert(), transition_points = {1:[325,399,0,100], 3:[250,324,500,600]})
